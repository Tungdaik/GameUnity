...
public class BulletStormSkill : BaseSkill
{
    ...
    protected void Spawnn()
    {
        ...
        bulletCrl.SetShooterName(transform.parent.parent.parent.parent.name);
        BulletCrl bulletCrl2 = newBullet2.GetComponent<BulletCrl>();
        bulletCrl2.SetShooterName(transform.parent.parent.parent.parent.name);
        BulletCrl bulletCrl3 = newBullet3.GetComponent<BulletCrl>();
        bulletCrl3.SetShooterName(transform.parent.parent.parent.parent.name);
        BulletCrl bulletCrl4 = newBullet4.GetComponent<BulletCrl>();
        bulletCrl4.SetShooterName(transform.parent.parent.parent.parent.name);
        BulletCrl bulletCrl5 = newBullet5.GetComponent<BulletCrl>();
        bulletCrl5.SetShooterName(transform.parent.parent.parent.parent.name);
